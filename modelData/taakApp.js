...
(function() {
  ...
  var tasks = [
      ...
      {"_id":"6", "type_id":"1",'isAssigned':false, "title":"Complete Task 5 ",'description':'complete the front end','progt':5,'taskSkills':['Machine Learning', 'Web Development','UI/UX'],priority: 'Med', assignee: ''},
      {"_id":"7", "type_id":"1",'isAssigned':false, "title":"Complete Task 5 ",'description':'complete the front end','progt':5,'taskSkills':['Machine Learning', 'OOP','UI/UX'],priority: 'Low', assignee: ''},
      {"_id":"8", "type_id":"1",'isAssigned':false, "title":"Complete Task 5 ",'description':'complete the front end','progt':5,'taskSkills':['Machine Learning', 'SQL','Python'],priority: 'High', assignee: ''},
      {"_id":"9", "type_id":"1",'isAssigned':false, "title":"Complete Task 5 ",'description':'complete the front end','progt':5,'taskSkills':['Machine Learning', 'R','Excel'],priority: 'Low', assignee: ''},
  ...
  var users = [
   {'uid':'1', 'u_name':'first last', 'skills': ['Machine Learning', 'Web Development', 'Object Oriented Programming','UI/UX'],
    'totalAvalability':[], 'task_assigned':['_id 1']} ,
    {'uid':'2', 'u_name':'first1 last1', 'skills': [ 'Object Oriented Programming','UI/UX'],
    'totalAvalability':[], 'task_assigned':['_id 1']}
    {'uid':'3', 'u_name':'first2 last2', 'skills': [ 'Machine Learning'],
    'totalAvalability':[], 'task_assigned':['_id 1']}
    {'uid':'4', 'u_name':'first3 last3', 'skills': ['Javascript','MongoDB'],
    'totalAvalability':[], 'task_assigned':['_id 1']}
  ]
